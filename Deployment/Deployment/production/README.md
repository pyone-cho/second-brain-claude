...
server {
    ...
    server_name sb.aitourkpc.site;

    ssl_certificate /etc/letsencrypt/live/sb.aitourkpc.site/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/sb.aitourkpc.site/privkey.pem;
